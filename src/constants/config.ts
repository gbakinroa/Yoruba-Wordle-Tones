export const CONFIG = {
  ...
  language: 'Yorùbá Wordle (alpha version with tones)', // This changes the display name for your language
  ...
  wordListSource: 'Jẹ́ K\'Á Sọ Yorùbá àti Jẹ́ K\'Á Ka Yorùbá', // Describe the source material for your words here
